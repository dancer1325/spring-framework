...
* [.small]#xref:web/webflux-cors.adoc[== in the Reactive stack]#
* Cross-Origin Resource Sharing
    ** -- can be managed by -- Spring MVC

[[mvc-cors-intro]]
== Introduction
* [.small]#xref:web/webflux-cors.adoc#webflux-cors-intro[== in the Reactive stack]#

* Browsers (for security reasons) -- prohibit -- AJAX calls to resources / outside the current origin
    ** _Example:_  bank account in one tab and evil.com in another tab / scripts from evil.com -- should NOT be able to make -- AJAX requests to your bank API with your
credentials
* := https://www.w3.org/TR/cors/[W3C specification] /
    ** implemented by https://caniuse.com/#feat=cors[most browsers]
    ** allows
        *** 👁️specifying what kind of cross-domain requests are authorized 👁️
    ** workarounds, less secure and powerful
        *** _Example:_ -- based on -- IFRAME or JSONP
