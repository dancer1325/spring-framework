...
* Provide xref:testing/integration.adoc#testing-fixture-di[Dependency Injection of test fixture instances].
* Provide xref:testing/integration.adoc#testing-tx[transaction management] / -- appropriate to -- integration testing.
